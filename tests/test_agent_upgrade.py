...
class AgentUpgradeTests(unittest.TestCase):
    ...
    def test_media_profile_follows_agent_profile_in_library(self):
        ...
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .monitor-card { grid-column: 7 / span 6; grid-row: 2; }", app.HTML)
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .resource-card { grid-column: 7 / span 6; grid-row: 3; }", app.HTML)
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .upload-card { grid-column: 1 / span 6; grid-row: 3; }", app.HTML)
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .agent-control-panel { grid-column: 1 / span 6; grid-row: 2; }", app.HTML)
        ...
        self.assertLess(command_position, agent_control_position)
        self.assertLess(agent_control_position, monitor_position)
        self.assertLess(monitor_position, resource_position)
        self.assertLess(resource_position, upload_position)
