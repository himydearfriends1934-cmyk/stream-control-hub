...
class AgentUpgradeTests(unittest.TestCase):
    ...
    def test_profiles_filter_resources_and_support_double_click_rename(self):
        ...
        self.assertIn('"identity online stream actions"', app.HTML)
        self.assertIn('"locks locks locks locks"', app.HTML)
        ...
        self.assertIn("grid-template-columns: minmax(0, 1fr) 64px 112px minmax(118px, .42fr)", app.HTML)
