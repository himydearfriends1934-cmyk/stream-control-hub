...
class AgentUpgradeTests(unittest.TestCase):
    ...
    def test_profiles_filter_resources_and_support_double_click_rename(self):
        ...
        self.assertIn("auto_tune_enabled: true", app.HTML)
        ...
        self.assertIn("grid-template-columns: 34px minmax(0, 1fr) 64px 142px minmax(118px, .42fr)", app.HTML)
        self.assertIn("grid-template-columns: repeat(3, minmax(0, 1fr))", app.HTML)
