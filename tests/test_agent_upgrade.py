...
class AgentUpgradeTests(unittest.TestCase):
    ...
    def test_media_profile_follows_agent_profile_in_library(self):
        ...
        self.assertIn(".fixed-content-grid .resource-card { order: 0; }", app.HTML)
        ...
        self.assertIn('class="grid fixed-content-grid"', app.HTML)
        ...
        fixed_content_position = app.HTML.index('<section class="grid fixed-content-grid">')
        ...
        self.assertLess(agent_control_position, fixed_content_position)
        self.assertLess(fixed_content_position, left_stack_start)
