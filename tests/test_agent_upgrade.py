...
class AgentUpgradeTests(unittest.TestCase):
    ...
    def test_ui_remembers_last_agent_and_keeps_role_actions_in_settings(self):
        ...
        self.assertIn('id="mediaGroupSearchInput"', app.HTML)
        self.assertIn('id="quickGroupBar"', app.HTML)
        self.assertIn('id="quickGroupAddBtn"', app.HTML)
        self.assertIn('id="quickGroupRemoveBtn"', app.HTML)
        ...
        self.assertIn("function createQuickGroup", app.HTML)
