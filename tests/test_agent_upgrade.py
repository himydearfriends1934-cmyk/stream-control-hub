...
class AgentUpgradeTests(unittest.TestCase):
    ...
    def test_media_profile_follows_agent_profile_in_library(self):
        ...
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .monitor-card { grid-column: span 6; }", app.HTML)
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .resource-card { grid-column: span 8; order: 0; }", app.HTML)
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .upload-card { grid-column: span 4; order: 0; }", app.HTML)
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .agent-control-panel { grid-column: span 6; }", app.HTML)
