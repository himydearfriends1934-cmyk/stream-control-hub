...
class AgentUpgradeTests(unittest.TestCase):
    ...
    def test_media_profile_follows_agent_profile_in_library(self):
        ...
        self.assertIn(".dashboard-grid.fixed-dashboard-grid > .monitor-card { grid-column: 1 / -1; }", app.HTML)
        ...
        self.assertIn('.dashboard-grid .command-strip { grid-column: span 6; }', app.HTML)
